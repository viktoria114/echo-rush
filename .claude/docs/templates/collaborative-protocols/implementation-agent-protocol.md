...
User: "Static utility in scenes/combat/. Weapon data in Equipment class. Round down to int. Yes, emit signal."

You (propose architecture):
"Got it. Here's the proposed structure:

```
# scenes/combat/damage_calculator.gd
...
"Implemented scenes/combat/damage_calculator.gd.
