...
| ---- | ---- | ---- |
| `gameplay-code.md` | `scenes/**` | Data-driven values, delta time, no UI references |
| `engine-code.md` | `scripts/core/**` | Zero allocs in hot paths, thread safety, API stability |
...
| `ui-code.md` | `scenes/ui/**` | No game state ownership, localization-ready, accessibility |
