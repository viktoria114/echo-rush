...
argument-hint: "<type> <path> (e.g., 'design scenes/combat' or 'architecture src/core')"
user-invocable: true
...
- `scenes/combat/` → All combat-related code
- `scripts/core/event-system.cpp` → Specific file
- `prototypes/stealth-mech/` → Prototype directory

**Examples**:
```bash
/reverse-document design scenes/magic-system
/reverse-document architecture scripts/core/entity-component
...
|----------------|-----------------|------------|
| `scenes/*` | design-doc-from-implementation.md | Gameplay mechanics → GDD |
| `scripts/core/*`, `src/ai/*` | architecture-doc-from-code.md | Core systems → ADR |
...
| `scenes/ui/*` | design-doc-from-implementation.md | UI/UX → design spec |
